...
/** 
 * Helper class for : CollaborateurCorba
 *  
 * @author OpenORB Compiler
 */ 
public class CollaborateurCorbaHelper
{
    ...
    /**
     * Insert CollaborateurCorba into an any
     * @param a an any
     * @param t CollaborateurCorba value
     */
    public static void insert(org.omg.CORBA.Any a, GestAcces.CollaborateurCorba t)
    {
        a.insert_Streamable(new GestAcces.CollaborateurCorbaHolder(t));
    }

    /**
     * Extract CollaborateurCorba from an any
     * @param a an any
     * @return the extracted CollaborateurCorba value
     */
    public static GestAcces.CollaborateurCorba extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestAcces.CollaborateurCorbaHolder)
                    return ((GestAcces.CollaborateurCorbaHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestAcces.CollaborateurCorbaHolder h = new GestAcces.CollaborateurCorbaHolder(read(a.create_input_stream()));
    ...
    /**
     * Return the CollaborateurCorba IDL ID
     * @return an ID
     */
    ...
    private final static String _id = "IDL:GestAcces/CollaborateurCorba:1.0";

    /**
     * Read CollaborateurCorba from a marshalled stream
     * @param istream the input stream
     * @return the readed CollaborateurCorba value
     */
     ...
     * @param value CollaborateurCorba value
     */
