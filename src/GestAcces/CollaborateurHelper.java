...
public class CollaborateurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, GestAcces.Collaborateur t)
    {
        a.insert_Streamable(new GestAcces.CollaborateurHolder(t));
    }
     ...
     */
    public static GestAcces.Collaborateur extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof GestAcces.CollaborateurHolder)
                    return ((GestAcces.CollaborateurHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            GestAcces.CollaborateurHolder h = new GestAcces.CollaborateurHolder(read(a.create_input_stream()));
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            synchronized(org.omg.CORBA.TypeCode.class) {
                ...
                _members[7].type = orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_short);
    ...
    private final static String _id = "IDL:GestAcces/Collaborateur:1.0";
     ...
     */
    public static GestAcces.Collaborateur read(org.omg.CORBA.portable.InputStream istream)
    {
        GestAcces.Collaborateur new_one = new GestAcces.Collaborateur();
        ...
        new_one.dateEntree = istream.read_short();
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, GestAcces.Collaborateur value)
    {
        ...
        ostream.write_short(value.dateEntree);
